...
const services_foodProduct_service = require("../../services/food-product.service.js");
...
const _sfc_main = {
  ...
  methods: {
    ...
    async loadProducts() {
      this.loading = true;
      try {
        this.categories = services_foodProduct_service.getFoodCategories();
        this.products = services_foodProduct_service.getFoodProducts(this.selectedCategory);
      } catch (err) {
        common_vendor.index.__f__("error", "at pages/food-healing/food-shop.vue:140", "Failed to load products:", err);
    ...
    filterByCategory(categoryId) {
      ...
      this.products = services_foodProduct_service.getFoodProducts(categoryId);
    },
    /**
     * 打开产品详情弹窗
    ...
    navigateToShop() {
      ...
      const shopUrl = services_foodProduct_service.getFoodShopUrl(this.selectedProduct.id);
      if (!shopUrl) {
        common_vendor.index.showToast({
          title: "商城链接暂不可用",
          icon: "none"
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    o: $data.selectedProduct.ingredients
  }, $data.selectedProduct.ingredients ? {
    p: common_vendor.t($data.selectedProduct.ingredients)
  } : {}, {
    q: $data.selectedProduct.taste
  }, $data.selectedProduct.taste ? {
    r: common_vendor.t($data.selectedProduct.taste)
  } : {}) : {}, {
    s: common_vendor.o((...args) => $options.navigateToShop && $options.navigateToShop(...args)),
    t: common_vendor.o(() => {
    }),
    v: common_vendor.o((...args) => $options.closeProductDetail && $options.closeProductDetail(...args))
  }) : {}, {
    w: $data.navPaddingTop + "px"
  });
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-09f1c67e"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/food-healing/food-shop.js.map
