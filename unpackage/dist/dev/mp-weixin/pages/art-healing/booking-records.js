...
const _sfc_main = {
  ...
  methods: {
    async loadBookings() {
      this.loading = true;
      try {
        this.bookings = await services_artBooking_service.ArtBookingService.getUserArtBookings();
      } catch (error) {
        common_vendor.index.__f__("error", "at pages/art-healing/booking-records.vue:78", "Failed to load bookings:", error);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.f($data.bookings, (booking, k0, i0) => {
      return {
        a: common_vendor.t(booking.festivalTitle),
        b: common_vendor.t($options.getStatusText(booking.status)),
        c: common_vendor.n($options.getStatusClass(booking.status)),
        d: common_vendor.t(booking.festivalDate),
        e: common_vendor.t(booking.festivalTime),
        f: common_vendor.t(booking.festivalLocation),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-61728388"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/art-healing/booking-records.js.map
