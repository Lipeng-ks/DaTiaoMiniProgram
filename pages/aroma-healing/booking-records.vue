    ...
    <view class="records-list" v-else-if="bookings.length > 0">
      ...
      >
        <view class="record-header">
          <text class="event-title">{{ booking.salonTitle }}</text>
        ...
        <view class="record-info">
          <view class="info-row">
            ...
            <text class="info-text">{{ booking.salonDate }} {{ booking.salonTime }}</text>
          </view>
          <view class="info-row">
            <text class="info-icon">📍</text>
            <text class="info-text">{{ booking.salonLocation }}</text>
          </view>
          <view class="info-row">
            <text class="info-icon">👤</text>
...
export default {
  ...
  methods: {
    async loadBookings() {
      this.loading = true
      try {
        // Get bookings sorted by salon date (ascending)
        this.bookings = await AromaBookingService.getUserAromaBookings()
      } catch (error) {
