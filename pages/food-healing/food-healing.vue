<template>
  <view class="food-healing-container">
    <!-- 自定义导航栏 -->
    <view class="custom-navbar" :style="{ paddingTop: statusBarHeight + 'px' }">
      ...
      <view class="navbar-content">
        ...
        <view class="navbar-center">
          <text class="navbar-title">食愈</text>
          <text class="navbar-subtitle">用美食疗愈味蕾</text>
        </view>
...
<style scoped>
.food-healing-container {
  min-height: 100vh;
  background: linear-gradient(180deg, #fff8e1 0%, #ffffff 50%);
}
...
.custom-navbar {
  ...
  z-index: 999;
  overflow: hidden;
  background: linear-gradient(120deg, #e65100 0%, #ff8f00 48%, #ffb300 100%);
  box-shadow: 0 20rpx 44rpx rgba(230, 81, 0, 0.25);
...
.navbar-ribbon {
  ...
  bottom: -32rpx;
  height: 96rpx;
  background: linear-gradient(115deg, rgba(255, 255, 255, 0.14), rgba(255, 224, 130, 0.26));
...
.navbar-pattern {
  ...
  inset: 0;
  background-image:
    radial-gradient(circle at 20% 40%, rgba(255, 255, 255, 0.16) 0, rgba(255, 255, 255, 0) 24%),
    radial-gradient(circle at 78% 18%, rgba(255, 255, 255, 0.12) 0, rgba(255, 255, 255, 0) 22%),
...
.entry-card {
  ...
  border-radius: 24rpx;
  padding: 36rpx;
  box-shadow: 0 8rpx 30rpx rgba(230, 81, 0, 0.1);
}
