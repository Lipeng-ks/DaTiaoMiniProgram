    ...
    <view class="records-list" v-else-if="bookings.length > 0">
      ...
      >
        <view class="record-header">
          <text class="event-title">{{ booking.experienceTitle }}</text>
        ...
        <view class="record-info">
          <view class="info-row">
            ...
            <text class="info-text">{{ booking.experienceDate }} {{ booking.experienceTime }}</text>
          </view>
          <view class="info-row">
            <text class="info-icon">📍</text>
            <text class="info-text">{{ booking.experienceLocation }}</text>
          </view>
          <view class="info-row">
            <text class="info-icon">👤</text>
...
export default {
  ...
  methods: {
    async loadBookings() {
      this.loading = true
      try {
        // Get bookings sorted by experience date (ascending)
        this.bookings = await FoodBookingService.getUserFoodBookings()
      } catch (error) {
