<template>
  <view class="art-healing-container">
    <!-- 自定义导航栏 -->
    <view class="custom-navbar" :style="{ paddingTop: statusBarHeight + 'px' }">
      ...
      <view class="navbar-content">
        ...
        <view class="navbar-center">
          <text class="navbar-title">艺愈</text>
          <text class="navbar-subtitle">探索壮族文创之美</text>
        </view>
...
.custom-navbar {
  ...
  z-index: 999;
  overflow: hidden;
  background: linear-gradient(120deg, #d84315 0%, #f57c00 45%, #ffb74d 100%);
...
.navbar-ribbon {
  ...
  bottom: -32rpx;
  height: 96rpx;
  background: linear-gradient(115deg, rgba(255, 255, 255, 0.14), rgba(255, 213, 128, 0.28));
...
.navbar-pattern {
  ...
  inset: 0;
  background-image:
    radial-gradient(circle at 20% 40%, rgba(255, 255, 255, 0.18) 0, rgba(255, 255, 255, 0) 24%),
    radial-gradient(circle at 80% 20%, rgba(255, 255, 255, 0.12) 0, rgba(255, 255, 255, 0) 20%),
...
.entry-card {
  ...
  border-radius: 24rpx;
  padding: 36rpx;
  box-shadow: 0 8rpx 30rpx rgba(230, 81, 0, 0.08);
}
