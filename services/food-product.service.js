 ...
 * 示例美食产品数据
 */
export const sampleFoodProducts = [
  // 糯米制品类
  {
    id: 'food-1',
    name: '五色糯米饭',
 ...
 * @returns {Array} 产品列表
 */
export function getFoodProducts(categoryId) {
 ...
 */
export function getFoodProductById(productId) {
  if (!productId) {
    return null
  }
 ...
 */
export function getFoodShopUrl(productId) {
